...
<form method='POST' action="https://getform.io/f/c9109bc7-2f98-4aab-ab53-228d596b6e77" className='flex flex-col max-w-[600px] w-full'>
  ...
  <button className='text-white border-2 hover:bg-gradient-to-l from-green-300 via-blue-500 to-purple-600 hover:border-gray-200 px-4 py-3 my-8 mx-auto flex items-center'>Lets work together!</button>
